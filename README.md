...
All images contain EXIF metadata such as latitude, longitude, and phone information. This data is extracted, preprocessed, and converted into coordinates relative to UNLV. Every image, building label, and coordinates are stored within an internal Pandas dataframe.

For easier visualization, a Matplotlib scatter plot is displayed after parsing, outlining all image locations and building perimeters.
